"""
single_pdf_pipeline.py (WITH CLOUD MONITORING)
-----------------------------------------------
Single-PDF pipeline with Google Cloud Monitoring integration.

Changes from original:
- Added timing and success tracking
- Integrated with cloud_monitoring.py
- Logs all pipeline stages to Cloud Monitoring
"""
...
try:
    from scripts.aws_extraction_scripts.cloud_monitoring import log_pdf_processing, log_error
    MONITORING_ENABLED = True
except ImportError:
    MONITORING_ENABLED = False
    print("⚠️  Cloud Monitoring not available (cloud_monitoring.py not found)")
...
# ---------------------------------------------------------------------
# Main pipeline with user-aware session naming + MONITORING
# ---------------------------------------------------------------------
def process_single_pdf_session(
    ...
    """
    Process one PDF with user-aware session tracking + Cloud Monitoring.
